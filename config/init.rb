#
# ==== Standalone MerbUsercss configuration
# 
...
Merb::Config.use do |c|
  ...
  c[:session_secret_key]  = 'c3415fd4908d601559b64ce130eacc48fb7841ce'
...
Merb::Slices::config[:merb_usercss][:user_block] = lambda { ".foo-#{rand(10)} {}" }
